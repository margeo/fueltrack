...
ΕΣΩΤΕΡΙΚΟΣ ΚΑΝΟΝΑΣ (μην το αναφέρεις): Χρησιμοποίησε μέγιστο 25 διαφορετικά υλικά σε όλη την εβδομάδα. Επανέλαβε τα ίδια υλικά σε διαφορετικούς συνδυασμούς. ΜΗΝ απαριθμείς τα υλικά. ΜΗΝ αναφέρεις τον αριθμό 25 ή οποιοδήποτε όριο στην απάντησή σου. ΜΗΝ γράφεις εισαγωγική παράγραφο — ξεκίνα ΑΜΕΣΩΣ με 📅 ΔΕΥΤΕΡΑ.
