    ...
    <>
      ...
      <div className="day-card">
        ...
        {currentMode.description && (
          <div style={{ background: "var(--bg-btn-light)", borderRadius: 10, padding: "8px 12px", marginTop: 10, fontSize: 12, color: "var(--text-muted)", border: "1px solid var(--border-color)" }}>
