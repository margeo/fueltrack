      ...
      <div className="app-container">
        <div className="app-header">
          <div className="app-header-left">
            <h1 style={{ display: "flex", alignItems: "center", gap: 8 }}><img src="/icon-192.png" alt="" style={{ width: 28, height: 28, borderRadius: 6 }} />FuelTrack <span style={{ fontSize: 12, fontWeight: 700 }}>Plan → Track → Achieve!</span></h1>
